...
%
\title{Multi-objective Bayesian optimisation using a summary attainment front acquisition function}
%
...
\section{Proposed method}\label{section:our_method}
...
In this section we compare the approach proposed in section \ref{section:our_method} to several others on the well-known walking fish group (WFG) problems \cite{huband2005scalable}. We measure the performance of the algorithms according to the dominated hypervolume (DHV), and the inverted generational distance plus (IGD+).
...
\begin{table}
    ...
    \begin{tabular}{|l|r|l|r|l|}
        \hline
        Problem &  Obj. & Domain & $d$ & Comment\\
        \hline
        WFG2 & 3 & $[0, 2d]^d$ & $5$ & multi-modal, discontinuous Pareto front, non-separable\\
